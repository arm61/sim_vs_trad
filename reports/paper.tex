...
Although it is not immediately apparent, this model offers a slight improvement in the agreement with the experimental data, with an average $\chi^2$ over all contrasts of \input{../output/traditional/ave_30_mod_chisq.txt}.
