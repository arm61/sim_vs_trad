...
\small
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lllll}
    ...
    \hline
    h-\ce{D2O} & \input{dspc_30_30_hd2o_chi.txt} &
    \input{dspc_slipids_30_hd2o_chi.txt} &
    \input{dspc_berger_30_hd2o_chi.txt} &
    \input{dspc_martini_30_hd2o_chi.txt} \\
    \ce{d_{13}}-ACMW & \input{dspc_30_30_d13acmw_chi.txt} &
    \input{dspc_slipids_30_d13acmw_chi.txt} &
    \input{dspc_berger_30_d13acmw_chi.txt} &
    \input{dspc_martini_30_d13acmw_chi.txt} \\
    \ce{d_{13}}-\ce{D2O} & \input{dspc_30_30_d13d2o_chi.txt} &
    \input{dspc_slipids_30_d13d2o_chi.txt} &
    \input{dspc_berger_30_d13d2o_chi.txt} &
    \input{dspc_martini_30_d13d2o_chi.txt} \\
    \ce{d_{70}}-ACMW & \input{dspc_30_30_d70acmw_chi.txt} &
    \input{dspc_slipids_30_d70acmw_chi.txt} &
    \input{dspc_berger_30_d70acmw_chi.txt} &
    \input{dspc_martini_30_d70acmw_chi.txt} \\
    \ce{d_{70}}-\ce{D2O} & \input{dspc_30_30_d70d2o_chi.txt} &
    \input{dspc_slipids_30_d70d2o_chi.txt} &
    \input{dspc_berger_30_d70d2o_chi.txt} &
    \input{dspc_martini_30_d70d2o_chi.txt} \\
    \ce{d_{83}}-ACMW & \input{dspc_30_30_d83acmw_chi.txt} &
    \input{dspc_slipids_30_d83acmw_chi.txt} &
    \input{dspc_berger_30_d83acmw_chi.txt} &
    \input{dspc_martini_30_d83acmw_chi.txt} \\
    \ce{d_{83}}-\ce{D2O} & \input{dspc_30_30_d83d2o_chi.txt} &
    \input{dspc_slipids_30_d83d2o_chi.txt} &
    \input{dspc_berger_30_d83d2o_chi.txt} &
    \input{dspc_martini_30_d83d2o_chi.txt} \\
    \hline
    Average$\pm$Standard deviation &
    \input{dspc_30_30_all_chi.txt} &
    \input{dspc_slipids_30_all_chi.txt} &
    \input{dspc_berger_30_all_chi.txt} &
    \input{dspc_martini_30_all_chi.txt} \\
    \hline
  \end{tabular*}
\end{table*}
%
...
\small
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}llllll}
    ...
    \hline
    20 & \input{dspc_20-d_h_20.tex} & \input{dspc_20-d_t_20.tex} & \input{dspc_20_rough_20.tex} & \input{dspc_20-phih_20.tex} & \input{dspc_20-V_t_20.tex} \\
    30 & \input{dspc_30-d_h_30.tex} & \input{dspc_30-d_t_30.tex} & \input{dspc_30_rough_30.tex} & \input{dspc_30-phih_30.tex} & \input{dspc_30-V_t_30.tex} \\
    40 & \input{dspc_40-d_h_40.tex} & \input{dspc_40-d_t_40.tex} & \input{dspc_40_rough_40.tex} & \input{dspc_40-phih_40.tex} & \input{dspc_40-V_t_40.tex} \\
    50 & \input{dspc_50-d_h_50.tex} & \input{dspc_50-d_t_50.tex} & \input{dspc_50_rough_50.tex} & \input{dspc_50-phih_50.tex} & \input{dspc_50-V_t_50.tex} \\
    \hline
  \end{tabular*}
\end{table*}
%
...
For the Slipid simulation, the tail length was found to be \input{dspc_slipids_30_dt.txt}~\si{\angstrom}, while for the Berger simulations a value of \input{dspc_berger_30_dt.txt}~\si{\angstrom} was obtained.
...
From the Slipids and Berger simulations, the number of water molecules per head group was found to be \input{dspc_30_slipids_wph.txt} and \input{dspc_30_berger_wph.txt} respectively.
These are in good agreement with the \input{dspc_30-wph_30.tex} found from the monolayer model method in conjunction with Equation \ref{equ:wph}.
...
However this decreases slightly within the lipid head, reaching a value of \input{slipids_position_C2_30.txt}\si{\angstrom} for the end of the head group.
...
\small
  ...
  \begin{tabular*}{0.48\textwidth}{@{\extracolsep{\fill}}llll}
    ...
    \hline
    Start-Head & \input{slipids_mean_N_30.txt} & \input{slipids_uq_N_30.txt} & \input{slipids_position_N_30.txt} \\
    Mid-Head & \input{slipids_mean_P_30.txt} & \input{slipids_uq_P_30.txt} & \input{slipids_position_P_30.txt} \\
    End-Head & \input{slipids_mean_C2_30.txt} & \input{slipids_uq_C2_30.txt} & \input{slipids_position_C2_30.txt} \\
    \hline
    Start-Tail 1 & \input{slipids_mean_C21_30.txt} & \input{slipids_uq_C21_30.txt} & \input{slipids_position_C21_30.txt} \\
    Start-Tail 2 & \input{slipids_mean_C31_30.txt} & \input{slipids_uq_C31_30.txt} & \input{slipids_position_C31_30.txt} \\
    Mid-Tail 1 & \input{slipids_mean_C29_30.txt} & \input{slipids_uq_C29_30.txt} & \input{slipids_position_C29_30.txt} \\
    Mid-Tail 2 & \input{slipids_mean_C39_30.txt} & \input{slipids_uq_C39_30.txt} & \input{slipids_position_C39_30.txt} \\
    End-Tail 1 & \input{slipids_mean_8C21_30.txt} & \input{slipids_uq_8C21_30.txt} & \input{slipids_position_8C21_30.txt} \\
    End-Tail 2 & \input{slipids_mean_8C31_30.txt} & \input{slipids_uq_8C31_30.txt} & \input{slipids_position_8C31_30.txt} \\
    \hline
  \end{tabular*}
\end{table}
%
