...
\title{Assessing molecular simulation for the analysis of lipid monolayer reflectometry}
...
\begin{description}
\item[Usage]
Electronic Supplementary Information (ESI) available: All analysis/plotting scripts and figure files, allowing for a fully reproducible, and automated, analysis workflow for the work presented is available at \url{https://github.com/arm61/sim_vs_trad} (DOI: 10.5281/zenodo.2600729) under a CC BY-SA 4.0 license.
